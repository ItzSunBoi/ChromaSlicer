...
static std::vector<std::string> s_Preset_printer_options {
    "printer_technology",
    "printable_area", "extruder_printable_area", "support_parallel_printheads", "enable_full_color_printing", "full_color_shell_thickness", "parallel_printheads_count", "parallel_printheads_bed_exclude_areas", "bed_exclude_area","bed_custom_texture", "bed_custom_model", "gcode_flavor",
